...
public class ItemDaoImpl extends HibernateDaoSupport implements BaseDao {
	...
	@Override
	public List queryObjectById(String hsql, int no, String pw)
			throws HibernateException {
		List list=getHibernateTemplate().find(hsql, no,pw);
		return list;
	}

	public List queryObjectById(String hsql, String v_title) throws HibernateException {
		List list=getHibernateTemplate().find(hsql, v_title);
		return list;
	}
